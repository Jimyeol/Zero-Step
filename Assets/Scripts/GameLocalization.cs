        ...
        {
            {
                ...
                new Dictionary<string, string>(StringComparer.Ordinal)
                {
                    ...
                    { "tutorial_cross_blast_description", "When you leave this tile, the up, down, left, and right neighbors lose 1 count. The tile you move into is not hit." },
            ...
            },
            {
                ...
                new Dictionary<string, string>(StringComparer.Ordinal)
                {
                    ...
                    { "tutorial_cross_blast_description", "이 타일에서 나가면 위, 아래, 왼쪽, 오른쪽 타일의 카운트가 1 줄어듭니다. 이동한 다음 타일은 폭발에 맞지 않습니다." },
